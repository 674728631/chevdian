...
@ApiModel(value = "Wrapper", description = "全局返回模板")
public class Wrapper<T> implements Serializable {
    ...
    @ApiModelProperty(name = "code", value = "编号", dataType = "int", example = "200")
    private int code;

    @ApiModelProperty(name = "message", value = "信息", dataType = "String", example = "操作成功")
    private String message;

    @ApiModelProperty(name = "result", value = "结果数据")
    private T result;
